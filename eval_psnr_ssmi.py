...
testset = glob.glob("data/test20/test_B/*.png")
# testset = glob.glob("data/test/*.png")

# output_folder = "predict_ohaze_unet_spp_swish_deeper_gan_4c"
# output_folder = "outputs/generator_60_159"
# output_folder = "outputs/train23"
output_folder = "data/test20/outputs/generator_120_151/"

txtfile = open(f"./{output_folder}/120_151_train20.txt", "w+")
...
for path in testset:
	...
	pred = cv2.imread(f"./{output_folder}/{fname}.png")
	print(pred.shape)
